    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        historyList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String dateDetails = allDatesHistory.get(position);
            ...
            DialogInterface.OnClickListener dialogClickListener = (dialog, which) -> {
                switch (which){
                    case DialogInterface.BUTTON_POSITIVE:
                        ...
                        String dateDetailsa = allDatesHistory.get(position);
                        List<UserHistory>userHistories= MetroDatabase.getInstance(this).userDAO().historyDayDetailsList(dateDetailsa);

                        Log.i("date", dateDetailsa + "");
